...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "fixed left-0 top-0 h-screen px-4 py-4 hidden md:flex flex-col bg-white w-[300px] shadow-lg z-50",
          className
        )}
        animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "h-10 px-4 py-4 flex flex-row md:hidden items-center justify-between bg-white w-full shadow-sm"
        )}
        {...props}
      >
